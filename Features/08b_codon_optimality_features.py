...
Purpose
-------
Calculate codon-optimality features for PTC-containing transcripts.

The optimal-codon reference is generated by:
...
is supplied to this script using `--optimal_codons`.

Features generated
------------------
1. CodonOptimalityFraction_CDS
   Fraction of optimal in-frame codons across the complete coding sequence.

2. CodonOptimalityFraction_PTCpm100nt
   Fraction of optimal codons within approximately +/-100 nt of the PTC.
...
Optimal codon definition:
    Lindeboom et al. (2016), using human tRNA gene copy number.
...
def main():
    ...
    ap.add_argument("--fasta",
                    required=True,
                    help="GRCh38/hg38 reference FASTA matching the GENCODE v26 annotation.")
